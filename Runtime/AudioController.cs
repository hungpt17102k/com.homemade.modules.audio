...
public class AudioController : MonoBehaviour
{
    ...
    {
        string nameClip = soundClip.ToString();
        AudioClip clip = Resources.Load<AudioClip>($"Audio/Sound/{nameClip}");
        Sound sound = new Sound(nameClip, clip);
    ...
    {
        string nameClip = musicClip.ToString();
        AudioClip clip = Resources.Load<AudioClip>($"Audio/Music/{nameClip}");
        Music music = new Music(nameClip, clip);
    ...
    public void PlaySound(SoundClips clip, float volumePercentage = 1.0f, float pitch = 1.0f)
    {
    ...
    public void PlayMusic(MusicClips clip, float volumePercentage = 1.0f)
    {
    ...
    public AudioCase PlaySmartSound(SoundClips clip, float volumePercentage = 1.0f, float pitch = 1.0f)
    {
        Sound sound = GetSound(clip);
    ...
    public AudioCase PlaySmartMusic(MusicClips clip, float volumePercentage = 1.0f, float pitch = 1.0f)
    {
        Music music = GetMusic(clip);
    ...
    {
        if (Enum.GetValues(typeof(MusicClips)).Length > 0)
        {
            MusicClips musicClip = AudioUtils.RandomEnumValue<MusicClips>();
